...
class ChatMemoryRepository:
    ...
    async def save_message(
        ...
        return message_doc["_id"]

    async def get_recent_messages(self, session_id: str, user_id: str, limit: int = None) -> List[Dict[str, Any]]:
    ...
    async def get_recent_messages_for_history(self, session_id: str, user_id: str, limit: int = 100) -> List[Dict[str, Any]]:
        ...
        ).sort("created_at", 1).limit(limit)  # 시간순 정렬
